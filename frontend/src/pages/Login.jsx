...
const Login = ({ onSwitchToRegister }) => {
  ...
  const handleDemoLogin = async () => {
    try {
      ...
      setError('Demo login failed. Please try typing email and password.');
    } finally {
      setSubmitting(false);
    }
  };
  ...
  return (
    <div className="min-h-screen bg-slate-100 dark:bg-slate-950 flex items-center justify-center p-4 sm:p-6 lg:p-8">
      <div className="w-full max-w-5xl grid grid-cols-1 md:grid-cols-12 rounded-3xl bg-white dark:bg-slate-900 overflow-hidden shadow-2xl border border-slate-200 dark:border-slate-800">
        ...
        {/* Left Side: Split Screen Hero Banner (Page 1) */}
        <div className="hidden md:flex md:col-span-6 flex-col justify-between p-8 bg-gradient-to-br from-indigo-900 via-indigo-800 to-slate-950 text-white relative overflow-hidden">
          ...
          {/* Center Main Hero Heading & Bullet Points */}
          <div className="relative z-10 space-y-6 my-auto pt-6 pb-6">
            <div className="space-y-2">
              <h2 className="text-3xl font-extrabold tracking-tight leading-tight">
                Your Academic<br />Productivity Partner
              </h2>
            ...
            <div className="space-y-4 pt-2">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h4 className="text-xs font-bold text-white">Organize Tasks</h4>
                  <p className="text-[11px] text-indigo-200/70">Keep track of your assignments and deadlines</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-[11px] text-indigo-200/70">Monitor your academic journey</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h4 className="text-xs font-bold text-white">Stay Focused</h4>
                  <p className="text-[11px] text-indigo-200/70">Build better habits with study sessions</p>
                </div>
              </div>
            </div>

            {/* Visual Vector Mock Artwork Card */}
            <div className="pt-4">
              <div className="rounded-2xl bg-slate-900/60 border border-white/10 p-3 backdrop-blur-md shadow-xl flex items-center justify-between">
                <div className="flex items-center gap-3">
                  <div className="w-8 h-8 rounded-lg bg-indigo-600 flex items-center justify-center text-white text-xs font-bold">
                    42%
                  </div>
                  <div>
                    <p className="text-[11px] font-bold text-white">Weekly Focus Goal</p>
                    <p className="text-[10px] text-indigo-200/70">12 Tasks Completed this week</p>
                  </div>
                </div>
        ...
        <div className="md:col-span-6 p-6 sm:p-10 flex flex-col justify-center space-y-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-800 rounded-xl pl-10 pr-4 py-2.5 text-xs font-medium text-slate-900 dark:text-slate-100 placeholder-slate-400 focus:outline-none focus:border-indigo-500 saas-focus"
                />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-800 rounded-xl pl-10 pr-10 py-2.5 text-xs font-medium text-slate-900 dark:text-slate-100 placeholder-slate-400 focus:outline-none focus:border-indigo-500 saas-focus"
                />
                <button
                  type="button"
            ...
            <div className="flex items-center justify-between text-xs">
              ...
              <a href="#forgot" onClick={(e) => { e.preventDefault(); alert('Password reset link sent to email'); }} className="text-indigo-600 dark:text-indigo-400 font-bold hover:underline">
                Forgot password?
              </a>
            </div>
            ...
            <Button
              ...
              variant="primary"
              size="md"
              className="w-full justify-center bg-indigo-600 hover:bg-indigo-700 py-2.5 text-xs font-bold"
